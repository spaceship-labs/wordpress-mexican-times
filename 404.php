	...
	<div class="content">
		...
		<div class="post error404 full-width">
			<div class="post-inner">
				...
				<h2 class="post-title"><?php _eti( 'Nada por aquí' ); ?></h2>
				<div class="clear"></div>
				<div class="entry">
					...
					<div class="search-block-large">
						<form method="get" action="<?php echo home_url(); ?>/">
							<button class="search-button" type="submit" value="<?php if( !$is_IE ) _eti( 'Buscar' , 'tie' ) ?>"><i class="fa fa-search"></i></button>	
				...
				<section id="related_posts">
					<div class="block-head">
						<h3><?php _eti( 'Te puede interesar' ); ?></h3><div class="stripe-line"></div>
					</div>
